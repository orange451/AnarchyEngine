...
import engine.gl.compute.shaders.MotionBlurShader;
import engine.gl.objects.Texture;

public class MotionBlur extends ComputePass<MotionBlurShader> {
	...
	protected void setupImage() {
		//glClearTexImage(super.mainTex.getTexture(), 0, GL_RGBA, GL_FLOAT, new float[] { 0, 0, 0, 0 });
	}
	...
	protected void setupTextures(RendererData rnd, ComputePipeline pi, Texture[] auxTex) {
		...
		pi.getMotionTex().active(GL_TEXTURE1);
	}
