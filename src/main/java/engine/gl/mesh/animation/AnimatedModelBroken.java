...
public class AnimatedModelBroken {
	...
	public static AnimatedModelBroken fromMM3D( ModelMM3D mm3d ) {
		// Create a new animated model
		AnimatedModelBroken model = new AnimatedModelBroken();
	...
	public AnimatedModelBroken( AnimatedModelBroken base ) {
		this();
