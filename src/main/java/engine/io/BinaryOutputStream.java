...
public final class BinaryOutputStream implements AutoCloseable {
	...
	/**
	 * Writes the specified 8-bit byte array to the binary output stream.
	 * @param x the {@code boolean} to write
	 */
	public void write(byte[] x) {
	...
	/**
	 * Writes the specified 32-bit int array to the binary output stream.
	 * @param x the {@code boolean} to write
	 */
	public void write(int[] x) {
		for (int i = 0; i < x.length; i++) {
	...
	/**
	 * Writes the specified 64-bit double array to the binary output stream.
	 * @param x the {@code boolean} to write
	 */
	public void write(double[] x) {
		for (int i = 0; i < x.length; i++) {
	...
	/**
	 * Writes the specified 64-bit long array to the binary output stream.
	 * @param x the {@code boolean} to write
	 */
	public void write(long[] x) {
		for (int i = 0; i < x.length; i++) {
	...
	/**
	 * Writes the specified 32-bit float array to the binary output stream.
	 * @param x the {@code boolean} to write
	 */
	public void write(float[] x) {
		for (int i = 0; i < x.length; i++) {
	...
	/**
	 * Writes the specified 16-bit short array to the binary output stream.
	 * @param x the {@code boolean} to write
	 */
	public void write(short[] x) {
		for (int i = 0; i < x.length; i++) {
	...
	/**
	 * Writes the specified 8-bit char array to the binary output stream.
	 * @param x the {@code boolean} to write
	 */
	public void write(char[] x) {
		for (int i = 0; i < x.length; i++) {
