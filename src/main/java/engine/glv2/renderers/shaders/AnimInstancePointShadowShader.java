...
public class AnimInstancePointShadowShader extends AnimInstanceBaseShadowShader {
	...
	protected void setupShader() {
		super.setupShader();
		super.addShader(new Shader("assets/shaders/renderers/AnimInstancePointShadow.vs", GL_VERTEX_SHADER));
